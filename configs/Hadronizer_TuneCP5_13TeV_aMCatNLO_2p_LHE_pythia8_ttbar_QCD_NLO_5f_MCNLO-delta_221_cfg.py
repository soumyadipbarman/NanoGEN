...
# with command line options: Configuration/GenProduction/python/fragment/Hadronizer_TuneCP5_13TeV_aMCatNLO_2p_LHE_pythia8_ttbar_QCD_NLO_5f_MCNLO-delta_221_cff.py --fileout file:ttbar_QCD_NLO_5f_MCNLO-delta_221.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/Hadronizer_TuneCP5_13TeV_aMCatNLO_2p_LHE_pythia8_ttbar_QCD_NLO_5f_MCNLO-delta_221_cfg.py --customise_commands process.source.firstRun=cms.untracked.uint32(1) -n 500 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/fragment/Hadronizer_TuneCP5_13TeV_aMCatNLO_2p_LHE_pythia8_ttbar_QCD_NLO_5f_MCNLO-delta_221_cff.py nevts:500'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:ttbar_QCD_NLO_5f_MCNLO-delta_221.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('../ttbar_QCD_NLO_5f_MCNLO-delta_221_slc7_amd64_gcc630_CMSSW_9_3_16_tarball.tar.xz'),
    #args = cms.vstring('/afs/cern.ch/work/s/sobarman/private/MC@NLO/Gridpack/ttbar/date_07092020/ttbar_QCD_NLO_5f_MCNLO-delta_221_slc7_amd64_gcc630_CMSSW_9_3_16_tarball.tar.xz'),
