...
# with command line options: Configuration/GenProduction/python/fragment/Hadronizer_TuneCP5_13TeV_aMCatNLO_2p_LHE_pythia8_ttbar_QCD_NLO_5f_mg273_v2_cff.py --fileout file:ttbar_QCD_NLO_5f_mg273_v2.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/Hadronizer_TuneCP5_13TeV_aMCatNLO_2p_LHE_pythia8_ttbar_QCD_NLO_5f_mg273_v2_cfg.py --customise_commands process.source.firstRun=cms.untracked.uint32(1) -n 100 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/fragment/Hadronizer_TuneCP5_13TeV_aMCatNLO_2p_LHE_pythia8_ttbar_QCD_NLO_5f_mg273_v2_cff.py nevts:100'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:ttbar_QCD_NLO_5f_mg273_v2.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    ...
    #args = cms.vstring('/afs/cern.ch/work/s/sobarman/private/Gridpack/MC@NLO-delta/date_17052021/ttbar_QCD_NLO_5f_mg273_slc7_amd64_gcc630_CMSSW_9_3_16_tarball.tar.xz'),
