...
# with command line options: Configuration/GenProduction/python/fragment/Hadronizer_TuneCP5_13TeV_aMCatNLO_2p_LHE_pythia8_ttbar_QCD_NLO_4f_mg265_cff.py --fileout file:ttbar_QCD_NLO_4f_mg265.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/Hadronizer_TuneCP5_13TeV_aMCatNLO_2p_LHE_pythia8_ttbar_QCD_NLO_4f_mg265_cfg.py --customise_commands process.source.firstRun=cms.untracked.uint32(1) -n 500 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/fragment/Hadronizer_TuneCP5_13TeV_aMCatNLO_2p_LHE_pythia8_ttbar_QCD_NLO_4f_mg265_cff.py nevts:500'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:ttbar_QCD_NLO_4f_mg265.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    ...
    #args = cms.vstring('/afs/cern.ch/work/s/sobarman/private/MC@NLO/Gridpack/ttbar_QCD_NLO_4f_mg265_slc6_amd64_gcc630_CMSSW_9_3_16_tarball.tar.xz'),
