...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/NanoGEN/python/Hadronizer_TuneCP5_13TeV_aMCatNLO_UNLOPS_LHE_pythia8_dyeej_2NLO3LO_5f_NLO_UNLOPS_ickkw0_cff.py nevts:100'),
