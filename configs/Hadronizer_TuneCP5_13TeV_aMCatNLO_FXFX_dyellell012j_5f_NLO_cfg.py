...
# with command line options: Configuration/NanoGEN/python/Hadronizer_TuneCP5_13TeV_aMCatNLO_FXFX_dyellell012j_5f_NLO_cff.py --fileout file:dyellell012j.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/Hadronizer_TuneCP5_13TeV_aMCatNLO_FXFX_dyellell012j_5f_NLO_cfg.py -n 100 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/NanoGEN/python/Hadronizer_TuneCP5_13TeV_aMCatNLO_FXFX_dyellell012j_5f_NLO_cff.py nevts:100'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:dyellell012j.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc7_amd64_gcc700/13TeV/madgraph/V5_2.6.5/dy_fxfx_incl/dyellell012j_5f_NLO_FXFX_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz'),
