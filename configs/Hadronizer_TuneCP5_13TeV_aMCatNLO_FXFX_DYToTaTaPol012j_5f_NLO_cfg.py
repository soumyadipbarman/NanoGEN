...
# with command line options: Configuration/NanoGEN/python/Hadronizer_TuneCP5_13TeV_aMCatNLO_FXFX_DYToTaTaPol012j_5f_NLO_cff.py --fileout file:DYToTaTaPol.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/Hadronizer_TuneCP5_13TeV_aMCatNLO_FXFX_DYToTaTaPol012j_5f_NLO_cfg.py -n 100 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/NanoGEN/python/Hadronizer_TuneCP5_13TeV_aMCatNLO_FXFX_DYToTaTaPol012j_5f_NLO_cff.py nevts:100'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:DYToTaTaPol.root'),
