...
config.JobType.psetName = '../configs/Hadronizer_TuneCP5_13TeV_aMCatNLO_2p_LHE_pythia8_ttbar_QCD_NLO_5f_MCNLO-delta_111_v2_cfg.py'
...
config.Data.outputPrimaryDataset = 'ttbar_QCD_NLO_5f_MCNLO-delta_111-v2'
